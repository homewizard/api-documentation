...
:::warning Inform the user
If you're implementing this, ensure your users clearly understand what the action does. Users often click buttons without fully knowing their purpose or later forget they've done so. This can lead them to believe the app or device is malfunctioning, prompting unnecessary support requests, which we want to avoid.

To prevent this, consider adding clear documentation or showing a confirmation popup before triggering this action.
:::
