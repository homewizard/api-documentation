...
:::danger TODO
This feature is not yet implemented, it should be moved from `/api/v2/identify` to `/api/v2/system/identify` to be consistent with the other endpoints.
:::
...
:::danger TODO
This feature is not yet implemented, it should be moved from `PUT /api/v2/system {"reboot": true}` to `/api/v2/system/reboot` to be consistent with the other endpoints.
:::
