...
If needed, you can reboot the device by calling the `/api/system/reboot` endpoint. After rebooting, the device will reconnect to WiFi and be ready for use again.
