...
| ---------------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| product_type     | string | The product type, see [Supported devices](/docs/getting-started#supported-devices). Make sure your application can handle other values for future products. |
