...
| --------------------------------------------------- | ---------------- | ---------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| wifi_ssid                                           | String           | Read-only  | The SSID of the Wi-Fi network.                                                                  | <Badge colorName='hw-green' icon="mdi:check">P1 Meter</Badge> <Badge colorName='hw-green' icon="mdi:check">kWh Meter</Badge> <Badge colorName='hw-green' icon="mdi:check">Plug-In Battery</Badge>                    |
| wifi_rssi_db                                        | Number           | Read-only  | The signal strength of the Wi-Fi network.                                                       | <Badge colorName='hw-green' icon="mdi:check">P1 Meter</Badge> <Badge colorName='hw-green' icon="mdi:check">kWh Meter</Badge> <Badge colorName='hw-green' icon="mdi:check">Plug-In Battery</Badge>                    |
| uptime_s                                            | Number           | Read-only  | The uptime of the device in seconds.                                                            | <Badge colorName='hw-green' icon="mdi:check">P1 Meter</Badge> <Badge colorName='hw-green' icon="mdi:check">kWh Meter</Badge> <Badge colorName='hw-green' icon="mdi:check">Plug-In Battery</Badge>                    |
| [cloud_enabled](#cloud-communication)               | Boolean          | Read/Write | The state of the cloud communication.                                                           | <Badge colorName='hw-green' icon="mdi:check">P1 Meter</Badge> <Badge colorName='hw-green' icon="mdi:check">kWh Meter</Badge> <Badge colorName='hw-green' icon="mdi:check" detail='read-only'>Plug-In Battery</Badge> |
| [status_led_brightness_pct](#status-led-brightness) | Number           | Read/Write | The brightness of the status LED in percent.                                                    | <Badge colorName='hw-green' icon="mdi:check">P1 Meter</Badge> <Badge colorName='hw-grey' icon="mdi:close">kWh Meter</Badge> <Badge colorName='hw-green' icon="mdi:check">Plug-In Battery</Badge>                     |
| [api_v1_enabled](#enable-or-disable-the-v1-api)     | Optional Boolean | Read/Write | The state of the v1 API, will be removed when API v1 is removed, so this parameter is optional. | <Badge colorName='hw-green' icon="mdi:check">P1 Meter</Badge> <Badge colorName='hw-green' icon="mdi:check">kWh Meter</Badge> <Badge colorName='hw-grey' icon="mdi:close">Plug-In Battery</Badge>                     |

## Actions.

| Action                | Description                                               | Availability                                                                                                                                                                                     |
| --------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Reboot](#reboot)     | Reboot the device                                         | <Badge colorName='hw-green' icon="mdi:check">P1 Meter</Badge> <Badge colorName='hw-green' icon="mdi:check">kWh Meter</Badge> <Badge colorName='hw-grey' icon="mdi:close">Plug-In Battery</Badge> |
| [Identify](#identify) | Let the device identify itself by blinking the status LED | <Badge colorName='hw-green' icon="mdi:check">P1 Meter</Badge> <Badge colorName='hw-grey' icon="mdi:close">kWh Meter</Badge> <Badge colorName='hw-green' icon="mdi:check">Plug-In Battery</Badge> |
