...
| [permissions](#permissions) | <Badge colorName='hw-purple' icon="mdi:test-tube" detail='2.2.0'>In bèta</Badge> | Array[String] | Read/Write\* | Permissions to allow charging, discharging, both, or neither. Read-only in `to_full` mode. |
| battery_count               | <Badge colorName='hw-purple' icon="mdi:test-tube" detail='2.2.0'>In bèta</Badge> | Number        | Read-only    | Number of connected Plug-In Batteries.                                                     |
