...
- A new field is added to the [Plug-In Battery API](/docs/v2/batteries): `to_full`. This field can be set to `true` to charge all connected Plug-In Batteries to 100% and can be set to `false` to disable this behavior.
