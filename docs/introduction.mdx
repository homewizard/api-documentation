...
The HomeWizard Energy API is moving to version 2, which is a more secure and feature-rich version of the API. In version 2 of the API, we have added the following features:
...
Read more about the [version 2](/docs/category/api-v2) of the API.
