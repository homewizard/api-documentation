...
The HomeWizard Energy API is moving to version 2, which is a more secure and feature-rich version of the API. In version 2 we add:

-   **HTTPS** - Your data is securely transmitted.
-   **Always available** - No need to turn on the API in the app.
-   **Authentication** - Only the devices you trust can access the API.
-   **Websocket support** - Get real-time push based updates.

Read more about the [version 2](/docs/v2) of the API.
