...
Each major version is supported for a minimum of one year. After this period, the older version will be marked as deprecated. A deprecated version will remain available as long as feasible, but may be removed at any time. To stay informed, [subscribe to updates](/docs/changelog#subscribe-to-updates).
